                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="fixa" v-model="despesaFixa" required>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="qtd_meses" min="0" max="12" :disabled="despesaFixa == 'nao'">
                                </div>
                            </div>
                        </div>
                    </div>
